...
import { EffortScatterChart } from './components/dashboard/EffortScatterChart';
import ActivityCalendar from './components/dashboard/ActivityCalendar';
import AddActivityModal from './components/modals/AddActivityModal';
import ProfileModal from './components/modals/ProfileModal';
import { FitnessStatus } from './components/dashboard/FitnessStatus';
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 font-sans pb-12">
      ...
      {/* STATUS BAR */}
      {uploadStatus && (
        <div className="bg-blue-600 text-white text-center py-2 text-xs font-bold uppercase animate-in slide-in-from-top">
          {uploadStatus}
        </div>
      )}
      ...
      <main className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {activities.length === 0 ? (
           <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200 max-w-2xl mx-auto mt-10">
              ...
              <p className="text-slate-500 mb-6">Importa tu CSV de Strava o añade un entreno manual para empezar.</p>
           </div>
        ) : (
          <>
            {/* 1. FILTROS DE TIEMPO */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-7 xl:col-span-8 grid grid-cols-1 gap-6">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 items-stretch">
                        ...
                        {/* MAPA DE ESFUERZO (Scatter Plot) */}
                        <div className="min-h-[350px]"> 
                            <EffortScatterChart activities={filteredData} settings={settings} />
                        </div>
                ...
                <div className="lg:col-span-5 xl:col-span-4 h-full">
                    {/* Altura ajustada para alinear visualmente con la columna izquierda */}
