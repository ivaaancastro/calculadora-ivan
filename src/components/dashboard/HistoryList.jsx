...
export const HistoryList = ({ activities }) => {
  // 1. ORDENAMIENTO EXPLÍCITO: De más reciente a más antigua
  // Creamos una copia con [...activities] para no mutar el original
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-2">
        <div className="space-y-1">
          {sortedActivities.slice(0, 50).map((act, i) => (
            <div key={i} className="group flex items-center justify-between p-2.5 hover:bg-slate-50 rounded-xl transition-all border border-transparent hover:border-slate-100 cursor-default">
              
              {/* IZQUIERDA: ICONO + TIPO + FECHA */}
